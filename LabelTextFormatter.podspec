Pod::Spec.new do |s|
  ...
  s.description  = "This is simple DateFormatter extension which allows you to set label text from AttributedString without the need to create any instances. Allows you to combine several AttributedStrings into one."
  s.homepage  = "https://github.com/idapgroup/DateFormatterConstructor"
  s.license   = { :type => "New BSD", :file => "LICENSE" }
  s.author    = { "IDAP Group" => "hello@idapgroup.com" }
  s.source    = { :git => "https://github.com/filippkos/LabelTextFormatter.git",
                  :tag => s.version.to_s }
